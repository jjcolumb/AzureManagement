...
namespace AzureManagement
{
    public static class Utilities
    {
        ...
        public static void Print(Microsoft.Azure.Management.ServiceBus.Fluent.ISubscription serviceBusSubscription)
        {
            StringBuilder builder = new StringBuilder()
        ...
        public static void PrintVault(IVault vault)
        {
            var info = new StringBuilder().Append("Key Vault: ").Append(vault.Id)
                ...
                .Append("\n\tSku: ").Append(vault.Sku.Name).Append(" - ").Append(Microsoft.Azure.Management.KeyVault.Fluent.Models.Sku.Family)
